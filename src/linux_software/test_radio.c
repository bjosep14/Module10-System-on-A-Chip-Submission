...
void print_benchmark(volatile unsigned int *periph_base)
{
    ...
    bits_read = (32 * 2048); 
    unsigned int bytes_transferred = bits_read/8; // change obviously
    double time_spent = time_elapsed/125e6; // change obviously
    throughput = ((bytes_transferred/1e6)/time_spent);
...
// first, get a pointer to the peripheral base address using /dev/mem and the function mmap
    ...
    printf("\r\n\r\n\r\nLab 10 Bryan Joseph - Custom Peripheral Demonstration\n\r");
